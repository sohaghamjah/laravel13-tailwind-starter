            ...
            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="flex items-center justify-between px-5 py-2 sm:px-3 sm:py-3 border-b border-gray-200 dark:border-gray-800">
                    ...
                    <x-action-button
                        ...
                        variant="primary"
                        label="Back to Users"
                        href="{{ route('admin.hrm.users.index') }}"
                    />
                </div>

                <div class="border-t border-gray-100 dark:border-gray-800">
                    <form action="{{ route('admin.hrm.users.store') }}" method="POST" class="p-5 sm:p-6" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <!-- Password -->
                            <div>
                                <x-input-label for="password" :value="__('Password')" :required="!isset($user)" />
                                <x-password-input
                                    name="password"
                                    id="password"
                            ...
                            <div>
                                ...
                                @if(isset($user) && $user->image)
                                    ...
                                    <div class="mt-2">
                                        <img src="{{  Storage::url(filesPath('users') . '/' . $user->image) }}" alt="Current Image" class="w-16 h-16 rounded-lg object-cover">
                        ...
                        <div class="flex items-center justify-end gap-3 pt-6 mt-6 border-t border-gray-100 dark:border-gray-800">
                            <x-cancle-action
                                :cancelRoute="route('admin.hrm.users.index')"
                            />
                           <x-submit-button
                                :text="isset($user) ? 'Update User' : 'Create User'"
                            />
                        </div>
                    </form>
                </div>
